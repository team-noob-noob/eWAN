...
namespace eWAN.WebApi.UseCases.Register
{
    ...
    public sealed class RegisterPresenter : IRegisterOutputPort
    {
        ...
        {
            var registerResponse = new RegisterResponse(output.newUser.Username);
            this.ViewModel = new CreatedAtRouteResult("Register", new {Username = output.newUser.Username});
        }
